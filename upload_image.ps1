$imagePath = "C:\Users\zukov\OneDrive\Desktop\Lab\lab_1\test_image.png"
...
$content.Add($byteContent, "file", "test_image.png")

$result = $client.PostAsync("http://127.0.0.1:3000/api/v1/inventory/6/image", $content).GetAwaiter().GetResult()
